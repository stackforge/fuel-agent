...
class TestSizes(unittest2.TestCase):
    test_cases = (
        ...
        ('1.456456 E', 1456456000000000000),
        ('1.4511 Zi', 1713156500823035609088),
        ('2 zetta', 2000000000000000000000),
        ('3.12Y', 3120000000000000033554432),
    )
    ...
    def test_not_supported_unit(self):
        test_cases = ('15b', '16mb', '12MEGAGIGA', '12', '42PETA')

        for test in test_cases:
            with self.assertRaisesRegexp(KeyError, 'unit is not supported'):
                SIZES[test]
