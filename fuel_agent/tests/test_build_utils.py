...
class BuildUtilsTestCase(unittest2.TestCase):
    ...
    def test_clean_apt_settings(self, mock_dirs, mock_files):
        ...
        files = {'etc/apt/sources.list', 'etc/apt/preferences',
                 'etc/apt/apt.conf.d/%s' % 'force_ipv4',
                 'etc/apt/apt.conf.d/%s' % 'unsigned',
                 'etc/apt/apt.conf.d/01mirantis-use-proxy-ftp',
                 'etc/apt/apt.conf.d/01mirantis-use-proxy-http',
                 'etc/apt/apt.conf.d/01mirantis-use-proxy-https'}
