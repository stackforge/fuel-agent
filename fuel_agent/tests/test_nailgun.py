...
class TestNailgunMockedMeta(unittest2.TestCase):
    def test_parse_operating_system_test_profiles(
        ...
        for profile, obj in d.iteritems():
            ...
            self.assertIsInstance(drv.operating_system, obj['obj'])
            self.assertEqual(obj['minor'], drv.operating_system.minor)
            self.assertEqual(obj['major'], drv.operating_system.major)
    ...
    def test_parse_operating_system_image_meta(self, mock_lbd,
        ...
        for os_name, obj in d.iteritems():
            mock_image_meta.return_value = {'os': {'name': os_name, 'minor': 1,
                                            'major': 2}}
