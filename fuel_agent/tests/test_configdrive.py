...
class TestConfigDriveScheme(unittest2.TestCase):
    ...
    def test_template_data_ok(self):
        ...
        cd_user_accounts = {}
        cd_user_accounts['service_user'] = configdrive.ConfigDriveUserAccount(
            'fuel', 'fuel', '/var/lib/fuel', ['ALL=(ALL) NOPASSWD: ALL']
        )
        cd_user_accounts['test_user'] = configdrive.ConfigDriveUserAccount(
            'test', 'test', '/home/test', ['SUDO'], ["SSH KEY"]
        )
