        ...
        with mock.patch('fuel_agent.manager.open', create=True) as mock_open:
            ...
            expected_write_calls = [
                ...
                mock.call('# Generated by fuel-agent during provisioning:\n# '
                          ...
                          'net-generator\n'),
                mock.call(b'UUID=fake_UUID /boot ext2 defaults 0 0\n'),
                mock.call(b'UUID=fake_UUID /tmp ext2 defaults 0 0\n'),
                mock.call(
                    b'UUID=fake_UUID / ext4 defaults,errors=panic 0 0\n'),
                mock.call(b'UUID=fake_UUID swap swap defaults 0 0\n'),
                mock.call(b'UUID=fake_UUID /var/lib/glance xfs defaults 0 0\n')
            ]
