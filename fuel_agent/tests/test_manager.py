...
class TestImageBuild(unittest2.TestCase):
    ...
    @mock.patch.object(manager.Manager, '_process_apt_sources')
    ...
    def test_do_build_image(self, mock_umount_target, mock_mount_target,
                            ...
                            mock_os, mock_utils,
                            mock_fu, mock_bu, mock_process_apt_sources):
        ...
        mock_process_apt_sources.return_value = metadata
        ...
        mock_bu.pre_apt_get.assert_called_once_with(
            ...
            direct_repo_addr='fake_addr')
        mock_process_apt_sources.assert_called_with(
            '/tmp/imgdir',
            mock.ANY,
