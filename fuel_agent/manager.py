...
#        grub.append_kernel_params('root=UUID=%s ' % mount2uuid['/'])
        grub.append_kernel_params('root=UUID={0} {1} '.format(mount2uuid['/'], 'debug ignore_loglevel LOGLEVEL=8 log_buf_len=10M udev.children-max=32 udev.debug udev.log-priority=debug console=ttyS0 '))
