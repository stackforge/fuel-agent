...
class Manager(object):
    ...
    def do_configdrive_ironic(self):
        LOG.debug('--- Adding configdrive (do_configdrive_ironic) ---')
    ...
    def do_bootloader(self, ironic_deploy=False):
    ...
    def do_provisioning_ironic(self):
        LOG.debug('--- Provisioning (do_provisioning_ironic) ---')
        self.do_partitioning()
        self.do_configdrive_ironic()
        self.do_copyimage()
        self.do_bootloader(ironic_deploy=True)
        LOG.debug('--- Provisioning END (do_provisioning_ironic) ---')
