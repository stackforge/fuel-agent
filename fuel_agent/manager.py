...
class Manager(object):
    ...
    def do_mkbootstrap(self):
        ...
        try:
            ...
            lvm_filter = set(lu.get_config_value('devices', 'filter') or [])
            lvm_filter.update(CONF.multipath_lvm_filter)
            lu.override_config_value('devices', 'filter', list(lvm_filter),
