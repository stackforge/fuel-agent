...
opts = [
    ...
    cfg.BoolOpt(
        ...
        help='For some environments(usually, with slow CPU), "parted" '
             ...
             'partitioning is doomed. Don\'t use this parameter with '
             'multipath devices! It  will brake provisioning!',
    ),
]
...
class Manager(object):
    ...
    def do_partitioning(self):
        ...
        if CONF.blacklist_udev_rules:
            ...
            utils. \
                blacklist_udev_rules(udev_rules_dir=CONF.udev_rules_dir,
