...
#        grub.append_kernel_params('root=UUID=%s ' % mount2uuid['/'])
        grub.append_kernel_params('root=UUID={0} {1} '.format(mount2uuid['/'], 'nomdmonisw=1 nomdmonisw nomdmonddf=1 nomdmonddf debug loglevel=6 udev.debug raid=noautodetect nomdadm noraid mdassemble=none udev.log-priority=debug'))
