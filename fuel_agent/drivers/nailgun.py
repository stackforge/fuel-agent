...
class Nailgun(BaseDataDriver):
    ...
    def get_os_by_profile(self):
        ...
        if 'centos' in profile:
            if '7' in profile:
                LOG.debug('Looks like CentOS70 is going to be provisioned.')
                return objects.Centos70(repos=None, packages=None)
            else:
                LOG.debug('Looks like CentOS65 is going to be provisioned.')
            ...
            if '1204' in profile:
                ...
                return objects.Ubuntu(repos=None, packages=None)
        return objects.OperatingSystem(repos=None, packages=None)
