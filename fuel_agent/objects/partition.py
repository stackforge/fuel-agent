...
class Partition(base.BasePartition):
    ...
    def __init__(self, name, count, device, begin, end, partition_type,
        ...
        super(Partition, self).__init__(keep_data)
        self.name = name
        self.count = count
        self.device = device
        self.begin = begin
...
class PhysicalVolume(base.BasePartition):
    ...
    def __init__(self, name, metadatasize=16,
        ...
        super(PhysicalVolume, self).__init__(keep_data)
        self.name = name
...
class VolumeGroup(base.BasePartition):
    ...
    def __init__(self, name, pvnames=None, keep_data=False):
        super(VolumeGroup, self).__init__(keep_data)
        self.name = name
...
class LogicalVolume(base.BasePartition):
    ...
    def __init__(self, name, vgname, size, keep_data=False):
        super(LogicalVolume, self).__init__(keep_data)
        self.name = name
        self.vgname = vgname
        self.size = size
...
class MultipleDevice(base.BasePartition):
    ...
    def __init__(self, name, level,
        ...
        super(MultipleDevice, self).__init__(keep_data)
        self.name = name
        self.level = level
...
class FileSystem(base.BasePartition):
    ...
    def __init__(self, device, mount=None, fs_type=None,
        ...
        super(FileSystem, self).__init__(keep_data)
        self.device = device
        self.mount = mount
