...
def blacklist_udev_rules(udev_rules_dir=None, udev_rules_lib_dir=None,
                         udev_rename_substr=None, udev_empty_rule=None):
...
def unblacklist_udev_rules(udev_rules_dir=None, udev_rename_substr=None):
