...
def do_post_inst(chroot, hashed_root_password,
    ...
    cloud_path = 'var/lib/cloud'
    if os.path.exists(os.path.join(chroot, cloud_path)):
        os.mkdir(os.path.join(chroot, cloud_path, 'data'))
        with open(os.path.join(chroot, cloud_path, 'data', 'upgraded-network'),
                  'w'):
            pass
