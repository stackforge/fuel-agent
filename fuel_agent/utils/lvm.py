...
def _update_raw_config(section, name, value, raw_config):
...
def override_config_value(section, name, value, lvm_conf_file):
    ...
    """
    updated_config = _update_raw_config(section, name, value,
                                        utils.execute('lvm dumpconfig')[0])
