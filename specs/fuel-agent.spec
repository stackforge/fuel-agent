...
%attr(0755,root,root)  %{_datadir}/fuel_bootstrap_cli/files/trusty/lib/udev/fix-renamed-net-config
%attr(0755,root,root)  %{_datadir}/fuel_bootstrap_cli/files/trusty/usr/share/initramfs-tools/hooks/netifnames
%attr(0755,root,root)  %{_datadir}/fuel_bootstrap_cli/files/trusty/usr/share/initramfs-tools/hooks/patch-live-boot-main
%attr(0755,root,root)  %{_datadir}/fuel_bootstrap_cli/files/trusty/lib/live/boot/9990-down-pxe-interface.sh
