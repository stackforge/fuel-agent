...
class DataBuilderTestCase(unittest.TestCase):
    ...
    def test_get_extra_dirs(self, conf_mock):
        ...
        result = self.bd_builder._get_extra_dirs()
        six.assertCountEqual(self, result, [DATA.get('extra_dirs')[0],
    ...
    def test_get_proxy_settings(self):
        ...
        self.bd_builder.direct_repo_addr = ['/test_repo_addr']
    ...
    def test_get_direct_repo_addr_conf(self, conf_mock):
        ...
        result = self.bd_builder._get_direct_repo_addr()
        six.assertCountEqual(self, result, ['/conf_test_repo_addr',
                                            self.bd_builder.direct_repo_addr[
                                                0]])
    ...
    def test_get_packages_not_no_default(self, conf_mock):
        ...
        result_packages = [self.bd_builder.packages[0],
                           DATA.get('kernel_flavor'),
                           conf_mock.packages[0]]
        six.assertCountEqual(self,
                             self.bd_builder._get_packages(), result_packages)
